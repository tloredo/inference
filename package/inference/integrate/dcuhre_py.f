...
cf2py intent(in) NUMFUN, MINPTS, MAXPTS, EPSABS, EPSREL
cf2py intent(in) KEY, NW, RESTAR
cf2py intent(out) RESULT, ABSERR, NEVAL, IFAIL
cf2py intent(inout) WORK
cf2py depend(NDIM) A, B
cf2py depend(NUMFUN) RESULT, ABSERR
cf2py depend(NW) WORK
