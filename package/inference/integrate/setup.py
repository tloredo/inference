...
def configuration(parent_package='',top_path=None):
	...
	config.add_extension('_adapt', ['adapt.pyf', 'adapt_py.f'])
	config.add_extension('_dcuhre', ['dcuhre.pyf', 'dcuhre_py.f', 'd07hre.f', 
	    'd09hre.f', 'd113re.f', 'd132re.f', 'dadhre.f', 'dchhre.f', 
	    'dfshre.f', 'dinhre.f', 'drlhre.f', 'dtrhre.f'])
...
if __name__ == "__main__":
	...
	setup(version='0.1',
          description='quad - Adaptive quadrature for the Inference package',
          author='Tom Loredo',
