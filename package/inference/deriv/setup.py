...
def configuration(parent_package='',top_path=None):
	...
	config = Configuration('deriv', parent_package, top_path)

	config.add_extension('_obsinfo', ['_obsinfo.pyf', '_obsinfo.f'])
...
if __name__ == "__main__":
	...
	setup(version='0.1',
          description='deriv: Tools for calculating derivatives for statistical computation',
          author='Tom Loredo',
