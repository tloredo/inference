...
C
     ...
     +                   KDIFF,START,BINSIZ,LSTEP,BWRK1,BWRK2,BWRK3,
     +                   ZXU,ZXC,Z1,ITEMP,INDEXX,ATIE,RISK,IWRK1,WRK1)
C
...
c Workspace:
cf2py intent(cache,hide) ZXU,ZXC,Z1,ITEMP,INDEXX,ATIE,RISK,IWRK1,WRK1
